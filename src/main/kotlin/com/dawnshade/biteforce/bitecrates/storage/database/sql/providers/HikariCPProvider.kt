...
import com.dawnshade.biteforce.bitecrates.storage.database.sql.ConnectionProvider
import com.zaxxer.hikari.HikariConfig
import com.zaxxer.hikari.HikariDataSource
import java.sql.Connection
import java.sql.SQLException

abstract class HikariCPProvider(private val storageConfig: BiteCratesConfig.Storage): ConnectionProvider {
    ...
    override fun init() {
        ...
        config.poolName = "BiteCrates-${getDriverName()}"
        ...
        try {
            ...
            com.dawnshade.biteforce.bitecrates.core.BiteCrates.LOGGER.error("Failed to initialize HikariCP tables for {}", getDriverName(), e)
        }
    }
